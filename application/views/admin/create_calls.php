...
<h3 class="text-center">Create New Call</h3>
<br>
<br>
 <hr>

<div class="clearfix"></div>
 <?php echo form_open($this->uri->uri_string(), array('class' => "form-horizontal form-groups-bordered", 'id' => 'order_form', "method" => "POST"));
				 ...
				 ?>
			      <div class="form-group">
					...
					<div class="form-group"> 
						<label for="caseID" class="col-sm-2  control-label">Case Number</label> 
						<div class="col-sm-5"> 
				...
				<div class="form-group"> 
					...
					<div class="form-group"> 
						<label for="appTime" class="col-sm-2  control-label">Appointment Time</label> 
						<div class="col-sm-5"> 
							<input type="text" name="appTime" class="form-control timepicker" data-template="dropdown" data-show-seconds="true" data-default-time="11:25 AM" data-show-meridian="true" data-minute-step="5" id="appTime" placeholder=""> 
						</div> 
					</div>
			      <div class="form-group">
